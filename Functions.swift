...
class Functions {
    ...
    // denne function bestemmer hvad der kan stå i et textfield det kaldes en regular expression meget avanceret, vil ikke komme meget ind på det.
    ...
    //denne function vil bruge en tidsinterval hvor den vil se om starttiden er er større end value og hvis den er det vil functionen stoppe, det samme med vis sluttiden er mindre en value. Hvis ingen af de ting sker vil den return value. Det sørger for at lave en pause.
